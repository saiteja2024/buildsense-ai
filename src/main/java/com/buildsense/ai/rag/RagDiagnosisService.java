...
public class RagDiagnosisService {
    ...
    public FinalBuildAnalysis diagnose(String buildLog) {
        ...
        try {
            ...
            // 6. Combine deterministic + RAG + LLM results
